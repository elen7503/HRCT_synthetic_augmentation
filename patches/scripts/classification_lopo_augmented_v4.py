...
ALL_IMGS_PATH = os.path.join(PROJECT_ROOT, "ILD_DB_npy_augmented_v3_5k/all_images.npy")
ALL_LBLS_PATH = os.path.join(PROJECT_ROOT, "ILD_DB_npy_augmented_v3_5k/all_labels.npy")
ALL_PIDS_PATH = os.path.join(PROJECT_ROOT, "ILD_DB_npy_augmented_v3_5k/all_patient_ids.npy")
...
def run_fold(fold_idx, n_folds, patient_id, all_images, all_labels, all_pids,
    ...
    # Class weighting, computed fresh per fold from that fold's actual train labels
    from sklearn.utils.class_weight import compute_class_weight
...
if __name__ == "__main__":
    ...
    # ── Logger ───────────────────────────────────────────────────────────────
    logger = Logger(f"lopo_augmented_v4_seed{args.seed}")
