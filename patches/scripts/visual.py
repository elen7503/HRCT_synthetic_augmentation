...
AUG_IMGS_PATH = os.path.join(PROJECT_ROOT, "patches/ILD_DB_npy_augmented/all_images.npy")
AUG_LBLS_PATH = os.path.join(PROJECT_ROOT, "patches/ILD_DB_npy_augmented/all_labels.npy")
AUG_PIDS_PATH = os.path.join(PROJECT_ROOT, "patches/ILD_DB_npy_augmented/all_patient_ids.npy")
