...
ALL_IMGS_PATH = os.path.join(PROJECT_ROOT, "ILD_DB_npy_augmented_v5/all_images.npy")
ALL_LBLS_PATH = os.path.join(PROJECT_ROOT, "ILD_DB_npy_augmented_v5/all_labels.npy")
ALL_PIDS_PATH = os.path.join(PROJECT_ROOT, "ILD_DB_npy_augmented_v5/all_patient_ids.npy")
...
if __name__ == "__main__":
    ...
    logger = Logger(f"lopo_augmented_v5_seed{args.seed}")
