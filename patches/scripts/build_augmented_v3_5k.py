...
class, plus a FIXED number of synthetic patches per class, regardless of how large that makes each
...
SYNTH_DIR = os.path.join(PROJECT_ROOT, "diffusion_model/outputs/synthetic_v3_5k")
OUT_DIR = os.path.join(PROJECT_ROOT, "ILD_DB_npy_augmented_v3_5k")
