...
#PBS -N lopo_v3_5k_fixed_seed0
#PBS -o $PBS_O_WORKDIR/logs/lopo_augmented_v3_5k_FIXED_seed0.out
#PBS -e $PBS_O_WORKDIR/logs/lopo_augmented_v3_5k_FIXED_seed0.err
...
echo "Start: $(date)"
python ${PROJECT_ROOT}/patches/scripts/classification_lopo_augmented_v3_5k.py --seed 0
echo "End: $(date)"
