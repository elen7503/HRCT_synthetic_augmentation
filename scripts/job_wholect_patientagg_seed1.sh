...
#PBS -N wholect_patientagg_s1
#PBS -o $PBS_O_WORKDIR/logs/wholect_patientagg_seed1.out
#PBS -e $PBS_O_WORKDIR/logs/wholect_patientagg_seed1.err
...
python ${PROJECT_ROOT}/wholect/scripts/classification_wholect_patientagg_lopo.py \
    --data-dir ${PROJECT_ROOT}/ILD_DB_wholect_uint8 --seed 1

echo "=== AUGMENTED seed1 ==="
python ${PROJECT_ROOT}/wholect/scripts/classification_wholect_patientagg_lopo.py \
    --data-dir ${PROJECT_ROOT}/ILD_DB_wholect_augmented --seed 1
