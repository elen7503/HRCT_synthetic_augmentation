...
#PBS -N lopo_v3_5k_fixed_seed2
#PBS -o $PBS_O_WORKDIR/logs/lopo_augmented_v3_5k_FIXED_seed2.out
#PBS -e $PBS_O_WORKDIR/logs/lopo_augmented_v3_5k_FIXED_seed2.err
...
echo "Start: $(date)"
python ${PROJECT_ROOT}/patches/scripts/classification_lopo_augmented_v3_5k.py --seed 2
echo "End: $(date)"
