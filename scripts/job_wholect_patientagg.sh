...
#PBS -N wholect_patientagg
#PBS -o $PBS_O_WORKDIR/logs/wholect_patientagg.out
#PBS -e $PBS_O_WORKDIR/logs/wholect_patientagg.err
...
python ${PROJECT_ROOT}/wholect/scripts/classification_wholect_patientagg_lopo.py \
    --data-dir ${PROJECT_ROOT}/ILD_DB_wholect_uint8 --seed 0
